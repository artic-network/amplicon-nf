...
payload = {
    ...
    "tool_name": "fieldbioinformatics-nf",
    "tool_version": "${workflow.manifest.version}",
    "citation_link": "https://github.com/artic-network/fieldbioinformatics-nf",
    "contact_email": "",
...
render_qc_report(
    ...
    output_path=Path(f"{payload['timestamp']}_fieldbioinformatics-nf_report.html"),
